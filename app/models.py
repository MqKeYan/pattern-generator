...
数学模型模块
============
5 种捕食者-猎物模型的反�应-扩散方程实现。
所有计算基于 PyTorch 张量，支持 GPU 加速。

模型列表:
    模型1 — Rosenzweig-MacArthur 型
    模型2 — Holling II 型
    模型3 — Ratio-dependent 型
    模型4 — 对称竞争模型
    模型5 — 连续化离散模型
"""
...
def laplacian(Z):
    ...
    参数:
        Z: (N, N) 形状的 PyTorch 张量

    返回:
        拉普拉斯运算结果
    """
    return (
        torch.roll(Z, 1, 0) + torch.roll(Z, -1, 0) +
        torch.roll(Z, 1, 1) + torch.roll(Z, -1, 1) -
        4.0 * Z
    )


# ============================================================
# 模型1：Rosenzweig-MacArthur 型捕食者-猎物
# ============================================================
def model_1(x, y, p):
    """Rosenzweig-MacArthur 型捕食者-猎物模型

    参数 p: [r, a, K, d, mu, D1, D2]
    """
    r, a, K, d, mu, D1, D2 = p
...
# ============================================================
# 模型2：Holling II 型捕食者-猎物
# ============================================================
def model_2(x, y, p):
    """Holling II 型捕食者-猎物模型

    参数 p: [r, a, b, c1, c2, D1, D2, R]
    """
...
# ============================================================
# 模型3：Ratio-dependent 捕食者-猎物
# ============================================================
def model_3(x, y, p):
    """Ratio-dependent 捕食者-猎物模型

    参数 p: [r, a, b, c, d, k, D1, D2]
    """
    r, a, b, c, d, k, D1, D2 = p
